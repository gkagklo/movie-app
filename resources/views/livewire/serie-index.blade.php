  ...
  <div class="w-full mb-4 p-2 flex justify-end">
    <form class="flex shadow bg-white rounded-md m-2 p-2">
      <div class="p-1 flex items-center">
        <label for="tmdb_id_g" class="block text-sm font-medium text-gray-700 md:mr-4">Serie Tmdb Id</label>
        ...
        <tbody class="bg-white">
          ...
          <tr class="text-gray-700">
            ...
            <td class="px-4 py-3 text-sm border">
              <a href="{{ route('admin.seasons.index', $serie->id)}}" class="px-4 py-2.5 bg-blue-300 text-gray-900 hover:bg-blue-500 rounded shadow">Seasons</a>
