        ...
        <tbody class="bg-white">
          ...
          <tr class="text-gray-700">
            ...
            <td class="px-4 py-3 text-sm border">
              <x-m-button wire:click="showEditModal({{$episode->id}})" class="bg-green-500 hover:bg-green-700 text-white">Edit</x-m-button>
              <x-m-button wire:click="deleteEpisode({{$episode->id}})" class="bg-red-500 hover:bg-red-700 text-white">Delete</x-m-button>
            </td>
          </tr>
          @endforeach
        </tbody>
