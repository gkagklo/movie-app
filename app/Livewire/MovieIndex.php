...
class MovieIndex extends Component
{
    ...
    public function generateMovie()
    {
        ...
        if ($movie) {
            $this->dispatch('banner-message', style: 'danger', message: 'Movie exists');
            return;
        }
        ...
        if ($apiMovie->successful()) {
            ...
            $this->reset('tmdbId');
            $this->dispatch('banner-message', style: 'success', message: 'Movie created');
        } else {
    ...
    public function updateMovie()
    {
        ...
        $this->dispatch('banner-message', style: 'success', message: 'Movie updated');
        $this->reset();
    }
    ...
    public function deleteMovie($movieId)
    {
        ...
        $movie->delete();
        $this->dispatch('banner-message', style: 'danger', message: 'Movie Deleted');
        $this->reset();
    }
    ...
    {
        $this->dispatch('banner-message', style: 'success', message: 'Tag Added');
        $this->reset();
    }

    public function tagDetached()
    {
        $this->dispatch('banner-message', style: 'danger', message: 'Tag detached');
        $this->reset();
    }
    public function castAdded()
    {
        $this->dispatch('banner-message', style: 'success', message: 'Cast Added');
        $this->reset();
    }

    public function castDetached()
    {
        $this->dispatch('banner-message', style: 'danger', message: 'Cast detached');
        $this->reset();
    }
